...
export default function PopupAdminPage() {
	...
	const handleSave = async () => {
		...
		try {
			...
			toast({
				title: "Success",
				description: "Popup content saved successfully",
			});
		} catch (error) {
	...
	return (
		<div>
			<Card className="max-w-4xl mx-auto">
				<CardHeader>
					<CardTitle>Popup Content Management</CardTitle>
					<CardDescription>
						Edit the content that will be displayed in the popup when users first visit the site
					</CardDescription>
				</CardHeader>
				<CardContent>
					...
					<div className="mt-6 flex justify-end">
						<Button onClick={handleSave} disabled={isLoading}>
							{isLoading ? "Saving..." : "Save Popup Content"}
						</Button>
					</div>
				</CardContent>
			</Card>
